...
//                 {/* left column */}
//                 <diV className='max-w-xl z-10 text-gray-500' >
//                     <h1 className='md:text-course-deatils-heading-large text-course-deatils-heading-small
...
//                     {/* review and rating */}
//                     <div className='flex items-center space-x-2 pt3 pb-1 text-sm'>
//                         <p> {calculateRating(courseData)} </p>
//                         <div className='flex'>
...
//                                                                         videoId: lecture.lectureUrl.split('/').pop()
//                                                                     })}
//                                                                     className='text-blue-500 cursor-pointer'>Preiew
//                                                                 </p>}
...
//                 overflow-y-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
...
//                             {isAlreadyEnroled ? 'Already Enrolled' : 'Enroll Now'}
//                         </button>
//                         <div className='pt-6'>
